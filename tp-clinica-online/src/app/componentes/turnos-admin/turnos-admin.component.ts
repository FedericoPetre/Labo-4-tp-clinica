...
export class TurnosAdminComponent {
  ...
  async cancelarTurno(turno:any){
    ...
    if (respuesta.isConfirmed) {
      ...
      this.firebase.cancelarTurnoPaciente(turno.especialidad, turno.especialista, turno.paciente, comentarioCancelacion, turno.diaDelTurno).then((respuesta:string)=>{
